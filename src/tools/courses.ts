...
export function register(
  ...
  server.registerTool(
    'auth_status',
    {
      title: 'Check Lamaku authentication',
      description:
        'Reports whether the server currently holds a usable Lamaku session, ' +
  ...
  server.registerTool(
    'whoami',
    {
      title: 'Who am I in Lamaku',
      description:
        'Returns the signed-in Lamaku user (name, username, internal user id). ' +
